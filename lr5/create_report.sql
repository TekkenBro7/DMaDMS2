CREATE TABLE c##myuser.reports_logs (
...
CREATE OR REPLACE PACKAGE c##myuser.report_pkg IS
  PROCEDURE create_report(p_start IN TIMESTAMP);
  PROCEDURE create_report;
END report_pkg;
/

CREATE OR REPLACE PACKAGE BODY c##myuser.report_pkg AS
  ...
  BEGIN
    ...
    INSERT INTO c##myuser.reports_logs (report_date, report_content)
