...
create table prod.tst_c1(id number primary key, id1 number);
/
create table prod.tst_c2(id number primary key, id2 number, FOREIGN KEY (id2) REFERENCES prod.tst_c1(id));
/
...
CREATE OR REPLACE PACKAGE prod.EmployeeManagement AS
